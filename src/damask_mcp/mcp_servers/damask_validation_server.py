...
from damask_mcp.tools.geometry import inspect_geometry_material_indices as inspect_geometry_material_indices_impl
from damask_mcp.tools.validation import (
...
from damask_mcp.adapter.validators import ensure_path_within_workspaces
from damask_mcp.adapter.workspace import workspaces_root
...
@mcp.tool()
def validate_material_yaml_structure(path: str) -> dict[str, Any]:
...
@mcp.tool()
def validate_load_yaml_structure(path: str) -> dict[str, Any]:
...
@mcp.tool()
def inspect_geometry_material_indices(path: str) -> dict[str, Any]:
